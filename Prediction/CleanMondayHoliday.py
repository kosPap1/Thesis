def CleanMondayPrediction():
    ...
    temperTrainDayTarget = load2016['2016-03-14']
    temperTrainDayMinus1 = load2016['2016-03-13']
    temperTrainDayMinus7 = load2016['2016-03-07']
    temperTrainDayMinus365 = load2015['2015-02-23']
    temperTrainDayMinus730 = load2014['2014-03-03']
    ...
    # Train temperature lag inputs
    temperTestDayTarget = load2019['2019-03-11']
    temperTestDayMinus1 = load2019['2019-03-10']
    temperTestDayMinus7 = load2019['2019-03-04']
    temperTestDayMinus365 = load2018['2018-02-19']
    temperTestDayMinus730 = load2017['2017-02-27']
    ...
    plt.title('Clean Monday Holiday')
    plt.legend()
    plt.show()
