def easterMonday():
    ...
    temperTrainDayTarget = load2016['2016-05-02']
    temperTrainDayMinus1 = load2016['2016-05-01']
    temperTrainDayMinus7 = load2016['2016-04-25']
    temperTrainDayMinus365 = load2015['2015-04-13']
    temperTrainDayMinus730 = load2014['2014-04-21']
    ##############################################
    ...
    # Train temperature lag inputs
    temperTestDayTarget = load2019['2019-04-29']
    temperTestDayMinus1 = load2019['2019-04-28']
    temperTestDayMinus7 = load2019['2019-04-22']
    temperTestDayMinus365 = load2018['2018-04-09']
    temperTestDayMinus730 = load2017['2017-04-17']
    ########################################################################################################################
    ...
    plt.title('Easter Monday Holiday')
    plt.legend()
    plt.show()
