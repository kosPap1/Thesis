def easterSunday():
    ...
    temperTrainDayTarget = load2016['2016-05-01']
    temperTrainDayMinus1 = load2016['2016-04-30']
    temperTrainDayMinus7 = load2016['2016-04-24']
    temperTrainDayMinus365 = load2015['2015-04-12']
    temperTrainDayMinus730 = load2014['2014-04-20']
    ...
    # Train temperature lag inputs
    temperTestDayTarget = load2019['2019-04-28']
    temperTestDayMinus1 = load2019['2019-04-27']
    temperTestDayMinus7 = load2019['2019-04-21']
    temperTestDayMinus365 = load2018['2018-04-08']
    temperTestDayMinus730 = load2017['2017-04-16']
    ...
    plt.title('Easter Sunday Holiday')
    plt.legend()
    plt.show()
