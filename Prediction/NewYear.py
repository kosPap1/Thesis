def newYear():
    ...
    temperTrainDayTarget = load2016['2016-01-01']
    temperTrainDayMinus1 = load2015['2015-12-29']
    temperTrainDayMinus7 = load2015['2015-12-25']
    temperTrainDayMinus365 = load2015['2015-01-01']
    temperTrainDayMinus730 = load2014['2014-01-01']
    ##############################################
    ...
    # Train temperature lag inputs
    temperTestDayTarget = load2019['2019-01-01']
    temperTestDayMinus1 = load2018['2018-12-29']
    temperTestDayMinus7 = load2018['2018-12-25']
    temperTestDayMinus365 = load2018['2018-01-01']
    temperTestDayMinus730 = load2017['2017-01-01']
    ...
    MLPreg = MLPRegressor(hidden_layer_sizes=(256, 256, 256), activation="relu", solver='adam', random_state=1,
