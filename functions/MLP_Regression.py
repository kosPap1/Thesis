...
import numpy as np
from functions.dataInput import load2013, load2014, load2015, load2016, load2017, load2018, load2019, temp2013, temp2014, temp2015, temp2016, temp2017, temp2018, temp2019
...
(weekDayLag1, weekDayLag2, weekDayLag3, weekDayLag4) = daysOfTheWeekReferance(loadTrainDayMinus1, loadTrainDayMinus7,
                                                                              loadTrainDayMinus365, loadTrainDayMinus730)

# Creating Train sets
trainSetX, trainSetY = setCreation(loadTarget, loadLag1, weekDayLag1, loadLag2, weekDayLag2, loadLag3, weekDayLag3,
                                   loadLag4, weekDayLag4, temperTarget, temperLag1, temperLag2, temperLag3, temperLag4)
...
(weekDayLag1, weekDayLag2, weekDayLag3, weekDayLag4) = daysOfTheWeekReferance(loadTestDayMinus1, loadTestDayMinus7,
                                                                              loadTestDayMinus365, loadTestDayMinus730)
